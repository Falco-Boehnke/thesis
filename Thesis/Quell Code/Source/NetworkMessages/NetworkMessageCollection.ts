...
export class NetworkMessageRtcAnswer implements NetworkMessageMessageBase {
    ...
    constructor(_originatorId: string, _targetId: string, _answer: RTCSessionDescription) {
        this.originatorId = _originatorId;
...
export interface PeerMessageMessageBase extends NetworkMessageMessageBase {
    readonly commandType: FudgeNetwork.SERVER_COMMAND_TYPE;
}

export class PeerMessageSimpleText implements PeerMessageMessageBase {
    originatorId: string;
...
export class PeerMessageDisconnectClient implements PeerMessageMessageBase {
    originatorId: string;
...
export class PeerMessageKeysInput implements PeerMessageMessageBase {
    originatorId: string;
    messageType: FudgeNetwork.MESSAGE_TYPE = FudgeNetwork.MESSAGE_TYPE.PEER_TO_SERVER_COMMAND;
