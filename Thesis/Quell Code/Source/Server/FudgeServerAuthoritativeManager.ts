...
export class FudgeServerAuthoritativeManager {
    ...
    private handleServerCommands = (_commandMessage: FudgeNetwork.PeerMessageMessageBase) => {
    ...
    private parseMessageToJson = (_messageToParse: string): FudgeNetwork.NetworkMessageMessageBase => {
    ...
    private dataChannelMessageHandler = (_message: MessageEvent) => {
        ...
        // tslint:disable-next-line: no-any
        let parsedMessage: FudgeNetwork.PeerMessageMessageBase = JSON.parse(_message.data);
