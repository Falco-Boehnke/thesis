...
export interface WSServer {
    ...
    createID(): string;
    parseMessageFromJson(_messageToParse: string): FudgeNetwork.NetworkMessageMessageBase;
...
export interface AuthoritativeSignalingServer extends SignalingServer {
}